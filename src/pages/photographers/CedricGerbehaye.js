      ...
      <div className="bg-Neutrals-Grey8 text-Neutrals-White">
        ...
        <div className="bg-Neutrals-Grey8 text-Neutrals-White px-4 mx-auto md:max-w-[76rem]">
          <section className="text-center">
            <div>
              <p className="H3">세드릭 게르베하이 - 콩고민주공화국</p>
        ...
        <div className="bg-Neutrals-Grey8 text-Neutrals-White px-4 mx-auto md:max-w-[76rem]">
          <section className="mb-[4rem]">
            ...
            <p className="max-w-[63rem] mx-auto DB1">
              ...
              Olivier Rebbot 상, 앰네스티 인터내셔널 국제 보도상, 세계보도사진상
              등을 받았다.
              <br />
              <br />
              게르베하이는 2011년 남수단에서 활동하며 신생독립국의 탄생과정을
              기록하고 이를 바탕으로 ‘랜드 오브 쿠시 Land of Cush, 2013’를
              출간했다. 게르베하이의 작품은 여러 전시회의 초청작으로 선정됐으며,
              매그넘 재단, 퓰리처위기보도센터, 저널리즘 펀드 등의 후원을 받았다.
              게르베하이의 사진은 휴스턴 미술관, 벨기에 샤를루아 미술관, 파리의
              유럽사진미술관, 앤트워프 사진박물관 FOMU 에서 소장하고 있다.
            </p>
          </section>
