          ...
          <section className="text-center">
            ...
            >
              <YouTube
                ...
                dataUrl="https://youtu.be/q4ILea6pdYI"
              />
            </div>
          </section>
          <section>
            ...
            <div>
              ...
              <div className="md:mb-[6rem] mb-[5rem] max-w-[63rem] mx-auto">
                <p className="mb-[3.5rem] DB1" {...animatedItem[9]}>
                  ...
                  농부였으며, 20살이 되던 1981년 가족과 함께 온두라스로
                  피난했다. 사진 속 에벨리오는 27살이었다. 아래는 마리나가
                  빈크에게 보낸 이메일 중 일부를 발췌한 내용이다.
                </p>
                ...
                <div className="flex gap-8 mb-8">
                  <div className="flex-1">
                    <p className="italic DB1" {...animatedItem[10]}>
                      ...
                      <br className="hidden md:block" />
                      하지만 어머니의 친구가 설득에 성공했고 그렇게 1990년 3월,
                      저희 아버지와 저, 제 남매들이 캐나다로 먼저
                      이주했습니다.&nbsp;
                      <br className="hidden md:block" />
                      ...
                      <br />
                      <br />
                      저는 항상 제가 어디 출신인지, 저희 가족이 그동안 어떤 일을
                      겪었는지 알고 싶었습니다.&nbsp;
                      <br className="hidden md:block" />
                      ...
                      합니다. <br />
                      <br />
                      어느 날 밤, 검색된 사진들을 보다가 제 아버지를
                      발견했습니다. 핸드폰으로 봤기 때문에 사진이 너무 작았지만
                      들것에 실린 그 남성이 제 아버지라는 사실을 확실히 알 수
                      있었죠.&nbsp;
                    </p>
                  </div>
                  <div
                ...
                <p className="italic DB1" {...animatedItem[11]}>
                  ...
                  사람이라고 되어 있었지만&nbsp; 당시 내전을 겪는 동안
                  엘살바도르 사람들이 신원을 보호하기 위해 가명을 쓰곤 해서 사진
                  속 그 남자가 제 아버지임을 확신했습니다.&nbsp; 나중에 어머니께
                  여쭤보니 에벨리오는 아버지가 쓰던 가명이었습니다.&nbsp; 그렇게
                  작가님의 앨범 전체를 보고, 가족에게도 사진을
                  보여주었습니다.&nbsp; 저와 할머니, 어머니가 아는 얼굴들과
                  친척들도 있었어요.&nbsp; 어머니와 할머니가 옛 추억을 떠올릴
                  만한 사진을 더 볼 수 있으면 좋겠다고 생각했습니다. 작가님께서
                  보여주신 사진으로 저희 가족이 지나온 힘든 세월을 더욱 잘
                  이해할 수 있게 되었습니다.&nbsp;
                  <br />
                  <br />
                  정말 감사합니다,
            ...
            <div>
              <div className="md:px-8 md:pt-8 md:pb-10 p-6 border md:mb-[5rem] mb-[4rem] border-Neutrals-Grey7 rounded-lg">
                ...
                <p className="DB1">
                  ...
                  대응해 긴급 구호 활동을 전개했으며, 현재는 수도 테구시갈파에서
