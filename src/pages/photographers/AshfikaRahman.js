...
const AshfikaRahman = () => {
  const animatedItem = {
    ...
    11: useScrollFadeIn("left", 1, 0.3),
    12: useScrollFadeIn("right", 1, 0.3),
          ...
          <section className="text-center">
            <div>
              ...
              >
                ...
                강제로 결혼해 출산을 겪지만 보건당국은 이들의 고통을 외면하고
                있다. 전통적인 성역할로 인해 자신의 신체와 관련된 성∙생식 문제에
                있어 스스로 결정하지 못할 뿐만 아니라 병원을 찾을 경제적 수단이
                없는 이 소녀들은 심리적∙의료적 지원이 필요하다. 아슈피카 라만은
                2021년 1월 캄란기르차르에 위치한 국경없는의사회 진료소를 찾아
        ...
        <div className="bg-Neutrals-Grey9 text-Neutrals-White px-4 mx-auto md:max-w-[76rem]">
          <section className="md:mb-[4rem] mb-[3rem]">
            ...
            <p className="max-w-[63rem] mx-auto DB1" {...animatedItem[14]}>
              ...
              <br />
              <br />
              라흐만은 2016년 시작한 장기 프로젝트를 통해 인도와 미얀마 사이
