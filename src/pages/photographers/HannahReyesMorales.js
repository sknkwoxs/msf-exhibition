          ...
          <section className="text-center">
            <div>
              ...
              >
                ...
                포토저널리스트 해나 레예스 모랄레스는 톤도 슬럼가에서 생활하며
                이곳의 의료 위기에 대한 인식을 제고하기 위해 지역주민의 모습을
                카메라에 담았다.
              </p>
            </div>
            <div
            ...
            >
              <YouTube
                ...
                dataUrl="https://youtu.be/tf_jWtTWdlM"
              />
            </div>
          </section>
          <section>
        ...
        <div className="bg-Neutrals-Grey9 text-Neutrals-White px-4 mx-auto md:max-w-[76rem]">
          <section className="md:mb-[4rem] mb-[3rem]">
            ...
            >
              ...
              <br />
              <br />
              최근 몇 년간 나온 필리핀에 대한 사진들은 대부분 폭력적이고
        ...
        <div className="bg-Neutrals-Grey9 text-Neutrals-White px-4 mx-auto md:max-w-[76rem]">
          <section className="md:mb-[4rem] mb-[3rem]">
            ...
            <p className="max-w-[63rem] mx-auto DB1" {...animatedItem[13]}>
              ...
              필리핀 해역에서의 인신매매(뉴욕 타임스), 캄보디아 여성이 겪은
