          ...
          <section className="text-center">
            <div>
              ...
              >
                ...
                있는 부르봉 아르고스호에는 수색구조팀을 비롯해 의료진, 식수위생
            ...
            >
              <YouTube
                ...
                dataUrl="https://youtu.be/LAuy3wP1p7A"
              />
            </div>
          </section>
          <section>
            <div>
              ...
              >
                ...
                오래전부터 존재해왔지만, 이주민이 첫발을 디딘 나라에서만
          ...
          <section className="max-w-[63rem] mx-auto md:pb-[8rem] pb-[6rem]">
            <div>
              <div className="md:px-8 md:pt-8 md:pb-10 p-6 border md:mb-[5rem] mb-[4rem] border-Neutrals-Grey7 rounded-lg">
                ...
                <p className="DB1">
                  2015년부터 지중해에서 난민 수색구조 활동을 전개했고, 지금까지
                  구조한 난민의 수는 8만여명에 이른다. 의료진, 로지스티션 등
                  다양한 전문가로 이뤄진 팀은 조난당한 해상난민을 구조하고
                  선상에서 응급처치를 제공한다. 국경없는의사회의 수색구조 활동은
                  이탈리아 해안경비대 및 로마 해상구조 조정 센터가 관장하는 국제
                  해역에서 이루어지며 국제해양법과 인도적 지원의 원칙에 따라
                  이루어진다.
                </p>
              </div>
              <div>
