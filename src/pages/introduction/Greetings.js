      ...
      <div>
        ...
        <div className="px-4 bg-center bg-no-repeat bg-cover DB1 text-Neutrals-Grey8 bg-bg-introduction">
          <div className="mx-auto md:max-w-[63rem]">
            <p
              className="hidden md:block md:py-[6rem] py-[3rem]"
              {...animatedItem[0]}
            >
              국경없는의사회
              ...
              자연재해의 영향을 받거나 의료서비스로부터 소외된 사람들에게
              의료지원을 제공합니다. 하지만 이에 더해 떼모아나지
              ...
              이야기를 전할 수 있는 예술입니다. 인도적 구호 현장에서의 사진은
              상황을 포착하고, 대상을 존중하며, 비인간적인 상황에서 인간성을
              유지하는 섬세한 과정입니다. 한 장의 사진이 역사를 쓰고, 우리
              사회를 반성하게 했습니다. 때로는 철학에 대한 열린 책이기도 합니다.
              <br />
              <br />
              국경없는의사회 한국 사무소는 설립 10주년을 맞이해 사진전{" "}
              <span className="font-PTBold">MORE THAN A PICTURE</span>를
              개최합니다. 보도사진 에이전시인 맵스 MAPS의 저명한
              포토저널리스트들이 찍은 사진을 모은 전시입니다. 전시회에 오셔서
              각각의 사진 뒤에 숨겨진 이야기를 발견하는 시간을 가지시길
              바랍니다.
              <br />
            ...
            <p className="md:hidden md:py-[6rem] py-[3rem]">
              국경없는의사회
              <span className="italic text-[14px]">Médecins San Frontière</span>
              는 인간 존엄성에 대한 존중으로 생명을 보호하고 고통을 완화하는 데
              기여하기 위해 시작됐습니다. 위험한 상황에 처한 환자들을 치료하고,
